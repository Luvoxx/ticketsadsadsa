...
> \`${prefix}personelayarla\` - Destek talebindeki personel rollerini ayarlar`)
  ...
  if (command == prefix + 'gönder' || command == prefix + 'destek') {
    ...
    .setLabel('Ürünler Hakkında Bilgi ')
    .setEmoji('898132754615660554')
    .setValue("urunler")
    .setDescription('Satın Alıcağınız Ürünler Hakkında Soru Sorabilirsiniz.')
    let button2 = new MessageMenuOption()
    .setLabel('Satış Sonrası Destek')
    .setEmoji('891459284183941170')
    .setValue("destek")
    .setDescription('Satın Aldığınız Ürünler Hakkında Soru Sorabilirsiniz.')
    let button3 = new MessageMenuOption()
    .setLabel('Partnerlik Başvurusu')
    .setEmoji('898080548256354314')
    .setValue("partner")
    .setDescription('Partnerlik Hakkında Soru Sorabilirsiniz.')
...
client.on('clickMenu', async (button) => {
  ...
  if (await db.get(`tickets_${button.id}_${button.message.guild.id}`)) {
    ...
    if (button.values[0] === "urunler") { //ürünler +
          button.guild.channels.create(`destek-${count}`, {
            ...
            ], parent: (await db.get(`Channels_${button.message.guild.id}.Cat`)), position: 1, topic: `Desteği Açan : <@!${button.clicker.user.id}>`, reason: "Tüm hakları selambenfc#2003'e aittir."
          }).then(async channel => {
            channel = channel
      ...
      **Ürünler Hakkında Bilgi Talebiniz Başarıyla Açıldı** <#${channel.id}>`, true)
                let log_embed = new Discord.MessageEmbed()
            ...
            const embedticket = new Discord.MessageEmbed()
              .setTimestamp()
              .setTitle("Konu : Ürünler Hakkında Bilgi") 
              .setFooter(``)
              .setColor(`#33cd15`)
      ...
      if (button.values[0] === "destek"){ // destek +
          button.guild.channels.create(`destek-${count}`, {
            ...
            await button.reply.edit(`
      **Satış Sonrası Destek Talebiniz Başarıyla Oluşturuldu** <#${channel.id}>`, true)
                let log_embed = new Discord.MessageEmbed()
            ...
            const embedticket = new Discord.MessageEmbed()
              .setTimestamp()
              .setTitle("Konu : Satış Sonrası Destek")
              .setFooter(``)
              .setColor(`#33cd15`)
              .setDescription(`Bu destek talebini kapatmak için 🔒 emojisine tıklayın`)
            let idd = randomstring.generate({ length: 25 })
  ...
  if (button.values[0] === "partner"){ // partner +
          button.guild.channels.create(`destek-${count}`, {
            ...
            await button.reply.edit(`
      **Partnerlik Talebiniz Başarıyla Oluşturuldu** <#${channel.id}>`, true)
                let log_embed = new Discord.MessageEmbed()
            ...
            const embedticket = new Discord.MessageEmbed()
              .setTimestamp()
              .setTitle("Konu : Partnerlik Başvurusu")
              .setFooter(``)
              .setColor(`#33cd15`)
              .setDescription(`Bu destek talebini kapatmak için 🔒 emojisine tıklayın`)
            let idd = randomstring.generate({ length: 25 })
